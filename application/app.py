...
async def most_recent_by_state(state):
    cursor.execute(
...
async def most_recent_cases_by_state(state):
    cursor.execute(
...
async def most_recent_dead_by_state(state):
    cursor.execute(
...
async def most_recent_by_statecounty(state):
    cursor.execute(
...
async def most_recent_cases_by_statecounty(state):
    cursor.execute(
...
async def most_recent_dead_by_statecounty(state):
    cursor.execute(
...
async def most_recent_by_county(state, county):
    cursor.execute(
...
async def most_recent_cases_by_county(state, county):
    cursor.execute(
...
async def most_recent_dead_by_county(state, county):
    cursor.execute(
...
async def timeseries_by_state(state):
    cursor.execute(
...
async def timeseries_of_cases_by_state(state):
    cursor.execute(
...
async def timeseries_of_deaths_by_state(state):
    cursor.execute(
...
async def timeseries_by_stateallcounties(state):
    cursor.execute(
...
async def timeseries_of_cases_by_stateallcounties(state):
    cursor.execute(
...
async def timeseries_of_deaths_by_stateallcounties(state):
    cursor.execute(
...
async def timeseries_by_statespeccounty(state, county):
    cursor.execute(
...
async def timeseries_of_cases_by_statespeccounty(state, county):
    cursor.execute(
...
async def timeseries_of_deaths_by_statespeccounty(state, county):
    cursor.execute(
...
async def deaths_by_date_for_all_states(date):
    cursor.execute(
...
async def totals_by_state_and_date(date, state):
    cursor.execute(
...
async def cases_by_state_and_date(date, state):
    cursor.execute(
...
async def deaths_by_state_and_date(date, state):
    cursor.execute(
...
async def statecounty_date(date, state):
    cursor.execute(
...
async def cases_by_statecountydate(date, state):
    cursor.execute(
...
async def dead_by_statecountydate(date, state):
    cursor.execute(
...
async def most_recent_by_county(date, state, county):
    cursor.execute(
...
async def most_recent_cases_by_county(date, state, county):
    cursor.execute(
...
async def most_recent_dead_by_county(date, state, county):
    cursor.execute(
